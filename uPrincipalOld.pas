...
procedure TfrmPrincipalOld.btnOSClick(Sender: TObject);
begin
...
procedure TfrmPrincipalOld.btnAlterarClick(Sender: TObject);
begin
...
procedure TfrmPrincipalOld.btnExcluirClick(Sender: TObject);
var desc : string;
begin
  if dtmPrincipal.qryPrincipal.RowsAffected < 1 then begin
...
procedure TfrmPrincipalOld.btnVendaClick(Sender: TObject);
begin
  try
    Application.CreateForm(TFrmVenda, frmVenda);
...
procedure TfrmPrincipalOld.FormShow(Sender: TObject);
var
